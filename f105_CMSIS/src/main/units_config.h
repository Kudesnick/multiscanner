...
//			<o5>Active level <0=>0 <1=>1
//		</e>
#define LIN2_ENABLED 1
#define LIN2_UNIT_NUM 5
#define LIN2_STB_AVAILABLE 1
#define LIN2_STB_PORT GPIO_PORT(2)
#define LIN2_STB_PIN_NUM 8
#define LIN2_STB_ON 1
...
#define LIN2_PULL_UP_MASTER_PORT GPIO_PORT(2)
#define LIN2_PULL_UP_MASTER_PIN_NUM 7
#define LIN2_PULL_UP_MASTER_ON 1
...
#define LIN2_PULL_UP_SLAVE_PORT GPIO_PORT(0)
#define LIN2_PULL_UP_SLAVE_PIN_NUM 7
#define LIN2_PULL_UP_SLAVE_ON 1
...
//      <o9>Tx buffer size (bytes) <8=>8 <16=>16 <32=>32 <64=>64 <128=>128 <256=>256 <512=>512 <1024=>1024 <2048=>2048 <4096=>4096 <8192=>8192 <16384=>16384 <32768=>32768
//      <o10>Rx buffer size (bytes) <8=>8 <16=>16 <32=>32 <64=>64 <128=>128 <256=>256 <512=>512 <1024=>1024 <2048=>2048 <4096=>4096 <8192=>8192 <16384=>16384 <32768=>32768
...
#define CON_TX_BUFFER_SIZE ((fifo_size_t)1024) ///< Длина буфера передатчика
#define CON_RX_BUFFER_SIZE ((fifo_size_t)256)  ///< Длина буфера приемника
...
#define IFACES_TX_BUFFER_SIZE ((fifo_size_t)8) ///< Размер буфера TX для интерфейсов
#define IFACES_RX_BUFFER_SIZE ((fifo_size_t)8) ///< Размер буфера RX для интерфейсов
//  </h>
